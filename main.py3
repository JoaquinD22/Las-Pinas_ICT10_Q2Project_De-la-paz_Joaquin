...
clubs = {
    ...
    "Ado voice Club 2": {
        "description": "ANOTHER CLUB SOP THAT YOU CAN SING LIKE ADO BUT FOR THE ONES WHO GRADUATED FROM ADO SINGING CLUB!!!",
        "meeting": "EVERYDAY 8-11:59 PM",
        "location": "ADO SIGNING HEADQUARTERS FOR PROS",
        "advisor": "MS. ADO",
...
def show_info(event):
    club = Element("ado_clubs_select").value
    info = clubs[club]
